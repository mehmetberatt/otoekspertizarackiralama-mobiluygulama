...
class FeaturedCarAdapter(
    private var cars: List<Car>,
    private val onCarClick: (Car) -> Unit
) : RecyclerView.Adapter<FeaturedCarAdapter.CarViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CarViewHolder {
        // We will assume "item_featured_dashboard_car" will be the name for the specialized layout
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_featured_dashboard_car, parent, false)
    ...
    inner class CarViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(car: Car) {
            ...
            tvPrice.text = "₺${car.pricePerDay} / gün"
